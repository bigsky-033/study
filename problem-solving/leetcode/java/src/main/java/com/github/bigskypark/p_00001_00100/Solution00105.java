...
public class Solution00105 {
  ...
  private TreeNode build(int preStart, int inStart, int inEnd, int[] preorder, int[] inorder) {
    ...
    /*
     * From: hyde, https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/discuss/34538/My-Accepted-Java-Solution/32854
     *
     ...
     *
     * Therefore the immediate right child index is preStart + numsOnLeft + 1 (remember in preorder traversal
     * array root is always ahead of children nodes but you don't know which one is the left child which
     * one is the right, and this is why we need inorder array)
     *
  ...
  public static void main(String[] args) {
    ...
    map.put("a", "b");
    String ret = map.computeIfAbsent("a", k -> k + "1");
