...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        private static final int SEQUENTIAL_THRESHOLD = 120000;
        /**
        ...
        protected void compute() {
            if (endIndexExclusive - startIndexInclusive <= SEQUENTIAL_THRESHOLD) {
                ...
                ReciprocalArraySumTask leftTask = new ReciprocalArraySumTask(startIndexInclusive, (startIndexInclusive + endIndexExclusive) / 2, input);
                ReciprocalArraySumTask rightTask = new ReciprocalArraySumTask((startIndexInclusive + endIndexExclusive) / 2, endIndexExclusive, input);
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        return tasks.stream().map(ReciprocalArraySumTask::getValue).reduce(0.0, Double::sum);
    }
