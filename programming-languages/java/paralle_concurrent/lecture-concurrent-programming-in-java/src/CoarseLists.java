...
public final class CoarseLists {
  ...
  public static final class CoarseList extends ListSet {
     ...
     * {@inheritDoc}
     *
     * <p>TODO Use a lock to protect against concurrent access.
     */
    @Override
   ...
   *
   * <p>TODO Implement the add, remove, and contains methods below to support correct, concurrent
   * access to this list. Use a Java ReentrantReadWriteLock object to protect against those
   * concurrent accesses. You may refer to SyncList.java for help understanding the list management
   * logic, and for guidance in understanding where to place lock-based synchronization.
   */
